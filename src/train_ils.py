"""
Train GNN on Indiana Limestone (ILS) Data
The critical test - well-connected rocks where topology should matter
"""
...
def load_ils_graphs(graphs_dir="data/graphs_ils"):
    """Load ILS graph data with 80/20 split"""
...
def main():
    print("="*70)
    print("🪨 ILS GNN TRAINING - THE FINAL TEST")
    print("="*70)
    print("\nHypothesis: ILS (well-connected) → GNN beats baseline")
    print("If GNN fails here too, topology truly doesn't matter\n")
    ...
    # Load data
    print(f"\n📁 Loading ILS Graphs...")
    train_graphs, test_graphs = load_ils_graphs()
    ...
    for epoch in range(1, 51):
        ...
        if test_loss < best_test_loss:
            ...
            best_epoch = epoch
            torch.save(model.state_dict(), 'models/best_model_ils.pth')
    ...
    # Final summary
    print(f"\n{'='*70}")
    print("✅ ILS TRAINING COMPLETE")
    print("="*70)
    print(f"Best Epoch: {best_epoch}")
    print(f"Best Test Loss (MSE): {best_test_loss:.4f}")
    print(f"Model saved to: models/best_model_ils.pth")
    
    print(f"\n{'='*70}")
    print("📊 NEXT STEP: Compare vs Baseline")
    print("="*70)
    print("Run: python src/baseline_ils.py")
    print("This is THE critical comparison!")
    print("="*70)
